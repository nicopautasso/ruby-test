...
def cargar_data
  ...
  cliente1.agregar_comprobante(comprobante1)
  cliente1.agregar_comprobante(comprobante2)
  cliente2.agregar_comprobante(comprobante3)
  cliente3.agregar_comprobante(comprobante4)
  cliente1.agregar_comprobante(comprobante5)
  cliente3.agregar_comprobante(comprobante6)
  cliente1.agregar_comprobante(comprobante7)
  cliente2.agregar_comprobante(comprobante8)
